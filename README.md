...
This project aims at collecting the database entries from
[ISBTF's LXX-NT project](https://projekte.isbtf.de/lxx-nt/)
and saving them as bibref statements. The project is a work in progress.
